...
public class SendEmailService {
    ...
    public Mail createMailAndChangePassword(String userEmail, String userName) {
        ...
        mail.setMessage("안녕하세요. [" + userName + "]님의 비밀번호 재설정 인증번호는 " + tempPassword + " 입니다. 인증번호는 3분 후에 무효화됩니다.");
    ...
    public void saveVerificationCode(String userEmail, String code) {
        redisTemplate.opsForValue().set(userEmail, code, 3, TimeUnit.MINUTES); //1분 타임아웃
    }
